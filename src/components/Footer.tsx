      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8">
            ...
            <span className="text-gray-500 hidden md:inline">·</span>
            <a href="/recursos.html" className="text-gray-700 hover:text-primary">Recursos</a>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200">
          ...
          <div className="flex space-x-6">
            <a href="https://wa.link/v80yk0" className="text-gray-600 hover:text-primary" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/juancvelam/" className="text-gray-600 hover:text-primary" target="_blank" rel="noopener noreferrer">
