...
const countries = [
  ...
  { value: "cape", label: "Cape Verde" },
  { value: "central", label: "Central African Republic" },
  ...
  { value: "east", label: "East Timor" },
  { value: "ecuador", label: "Ecuador" },
  { value: "egypt", label: "Egypt" },
  { value: "el", label: "El Salvador" },
  { value: "equatorial", label: "Equatorial Guinea" },
  ...
  { value: "st-kitts", label: "St. Kitts and Nevis" },
  { value: "st-lucia", label: "St. Lucia" },
  { value: "st-vincent", label: "St. Vincent and the Grenadines" },
